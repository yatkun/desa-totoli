            ...
            <div class="card card-outline card-primary rounded-0 elevation-0">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="/dashboard/aparaturdesa/hapus/{{$post->id}}"
                ...
                <form action="{{ route('aparatur.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            is-invalid
                        @enderror" id="nama" name="nama" placeholder="Masukkan nama lengkap" value="{{ $post->nama }}"
                                autofocus>
                            @error('nama')
                        ...
                        <div class="form-group">
                            ...
                            is-invalid
                        @enderror" id="jabatan" name="jabatan" placeholder="Masukkan jabatan" value="{{ $post->jabatan }}"
                                >
                            @error('jabatan')
                            <div class="invalid-feedback">
                                {{ $message }}
