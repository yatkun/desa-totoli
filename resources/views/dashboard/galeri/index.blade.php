            ...
            <div class="card card-outline card-primary rounded-0 elevation-0">
                <div class="card-header">
                    <div class="card-title ">
                        <a href="/dashboard/galeri/tambah" class="btn btn-success btn-sm">Tambah Galeri</a>
                    </div>
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a href="{{url('dashboard/galeri/edit')}}/{{$galeri->id}}">{{ $i++ }}</a></td>
                                <td>
                                    <img src="{{ asset('storage/'.$galeri->gambar) }}" class="img-thumbnail" style="width:300px; height:200px; object-fit:cover">
                                </td>
