            ...
            <div class="card card-outline card-primary rounded-0 elevation-0">
                <div class="card-header">
                    <div class="card-title ">
                        <a href="/dashboard/pengumuman" class="btn btn-info">Kembali</a>
                    </div>

                    <div class="card-tools">
                        <a href="/dashboard/pengumuman/hapus/{{$post->id}}"
                            onclick="return confirm('Apakah Anda Yakin Menghapus Pengumuman Ini?');"
                ...
                <form action="{{ route('pengumuman.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
